...
#include "first_interfaces/msg/rosidl_typesupport_c__visibility_control.h"
...
static const _Log_type_support_symbol_names_t _Log_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, first_interfaces, msg, Log)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, first_interfaces, msg, Log)),
  }
};
...
ROSIDL_TYPESUPPORT_C_EXPORT_first_interfaces
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, first_interfaces, msg, Log)() {
  return &::first_interfaces::msg::rosidl_typesupport_c::Log_message_type_support_handle;
}
