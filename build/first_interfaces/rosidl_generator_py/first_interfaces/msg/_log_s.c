...
bool first_interfaces__msg__log__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("first_interfaces.msg._log.Log", full_classname_dest, 29) == 0);
  }
  first_interfaces__msg__Log * ros_message = _ros_message;
  {  // filename
  ...
  {  // message_log
    PyObject * field = PyObject_GetAttrString(_pymsg, "message_log");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->message_log, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // level
...
PyObject * first_interfaces__msg__log__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("first_interfaces.msg._log");
  ...
  {  // message_log
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->message_log.data,
      strlen(ros_message->message_log.data),
      "strict");
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "message_log", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
